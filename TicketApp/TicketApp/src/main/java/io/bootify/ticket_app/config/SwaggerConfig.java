...
// Import necessary Swagger and Spring classes for API documentation and customization
...
// Marks this class as a Spring configuration class for setting up Swagger/OpenAPI
@Configuration
public class SwaggerConfig {

    // Defines a bean for configuring the OpenAPI specification
    @Bean
    ...
    // Defines a bean for customizing operations in OpenAPI
    @Bean
